...
*@version 1.0.0
*/
class AFX_EXT_CLASS KAdoPreparedStatement : public KPreparedStatement
{
public:
    KAdoPreparedStatement(AdoConnectionPtr spAdoConnection, CString strQuery);
    virtual ~KAdoPreparedStatement();
public:
	/**
	*@brief NULL묶음
