/**
 * @file KInspectionNodeDlg.h
 * @brief 노드 데이터 오류 검증 다이얼로그
...
* @date 2011.08.28
*/
class KInspectionNodeDlg : public KResizeDialogEx
{
	DECLARE_DYNAMIC(KInspectionNodeDlg)
private:
    /**
...
public:
	KInspectionNodeDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KInspectionNodeDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_5130_InspectionNodeDlg };
...
typedef std::shared_ptr<KInspectionNodeDlg> KInspectionNodeDlgPtr;