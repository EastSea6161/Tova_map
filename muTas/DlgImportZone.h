...
class KDlgImportZone : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportZone)

public:
	KDlgImportZone(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportZone();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_03_IMPORT_TABLE_ZONE };
