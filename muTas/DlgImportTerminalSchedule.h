...
class KDlgImportTerminalSchedule : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportTerminalSchedule)

public:
	KDlgImportTerminalSchedule(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportTerminalSchedule();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_08_IMPORT_TABLE_TERMINALSCHEDULE };
...
private:
	...
	bool         IsScheduleID(Integer a_nxValue);
...
protected :
	...
	std::set<Integer>           m_setTerminalScheduleID;
