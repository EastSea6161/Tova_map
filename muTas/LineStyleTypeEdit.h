...
class KLineStyleTypeEdit : public KDialogEx
{
	DECLARE_DYNAMIC(KLineStyleTypeEdit)

public:
	KLineStyleTypeEdit(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KLineStyleTypeEdit();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_TOC_STYLE_LINE_TYPEEDIT };
