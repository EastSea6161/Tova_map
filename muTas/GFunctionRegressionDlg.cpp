// GFunctionRegressionDlg.cpp : 구현 파일입니다.
//
...
// KGFunctionRegressionDlg 대화 상자입니다.
IMPLEMENT_DYNAMIC(KGFunctionRegressionDlg, KDialogEx)

KGFunctionRegressionDlg::KGFunctionRegressionDlg(CWnd* pParent /*=NULL*/)
	:	KDialogEx(KGFunctionRegressionDlg::IDD, pParent),
		m_strExpression(_T("")),
		m_pExpression(NULL)
{
...
KGFunctionRegressionDlg::~KGFunctionRegressionDlg()
{
}

void KGFunctionRegressionDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(KGFunctionRegressionDlg, KDialogEx)
	ON_BN_CLICKED(IDOK, &KGFunctionRegressionDlg::OnBnClickedOk)
	ON_LBN_DBLCLK(IDC_LIST1, &KGFunctionRegressionDlg::OnDblclkList1)
	ON_LBN_DBLCLK(IDC_LIST5, &KGFunctionRegressionDlg::OnDblclkList2)
	ON_LBN_DBLCLK(IDC_LIST3, &KGFunctionRegressionDlg::OnDblclkList3)
END_MESSAGE_MAP()




void KGFunctionRegressionDlg::Expression(KGRegressionExpression* pExpression)
{
...
//Step 1
BOOL KGFunctionRegressionDlg::OnInitDialog()
{
...
void KGFunctionRegressionDlg::initFieldList(void)
{
...
void KGFunctionRegressionDlg::initOperatorList(void)
{
...
void KGFunctionRegressionDlg::initFunctionList(void)
{
...
//Step 2
void KGFunctionRegressionDlg::OnDblclkList1()
{
	UpdateData(TRUE);
...
//Step 3
void KGFunctionRegressionDlg::OnDblclkList2()
{
	UpdateData(TRUE);
...
//Step 4
void KGFunctionRegressionDlg::OnDblclkList3()
{
	UpdateData(TRUE);
...
//Step 5
void KGFunctionRegressionDlg::OnBnClickedOk()
{
...
bool KGFunctionRegressionDlg::isField(LPCTSTR a_strElement)
{
...
std::tstring KGFunctionRegressionDlg::getFieldName(LPCTSTR a_strElement)
{
	std::tstring str = a_strElement;
...
std::tstring KGFunctionRegressionDlg::getFieldCaption(LPCTSTR a_strElement)
{
...
bool KGFunctionRegressionDlg::isOperator(LPCTSTR a_strElement)
{
	std::tstring str = a_strElement;
...
bool KGFunctionRegressionDlg::isFunction(LPCTSTR a_strElement)
{
	std::tstring str = a_strElement;
	int nFunction = sizeof(szFunctions) / sizeof(TCHAR*);
	for(int i = 0; i < nFunction; ++i)
...
void KGFunctionRegressionDlg::SetExpressionView(LPCTSTR a_strExpression)
{
	m_strExpression = a_strExpression;
}

void KGFunctionRegressionDlg::SetTarget( KTarget* a_pTarget )
{
	if(a_pTarget == NULL)
	{
		return;
