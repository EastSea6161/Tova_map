...
void KInterModalMainDlg::InitButtonControl()
{
	...
	double fontSize1 = 12.5 * (dpi / 96.0f);
	double fontSize2 = 11.0 * (dpi / 96.0f);

	m_lblModel.MoveWindow(&rc);

	CString modelXamlKR;
	modelXamlKR.Format(
		_T("<Border Width='%d' Height='%d' Margin='0,0,0,0' BorderBrush='Red' BorderThickness='0,0,0,0' CornerRadius='3,3,3,3'>")
		...
		_T("    <Border Width='%d' Height='1' Background='#7c96b5' />")
		_T("    <Border Width='%d' Height='1' Background='#9acae4' />")
		_T("    <TextBlock TextAlignment='Center' Padding='0, 20, 0, 10' FontSize='%f' Foreground='#000000'>수단선택, 대중교통 통행배정,</TextBlock>")
		_T("    <TextBlock TextAlignment='Center' FontSize='%f' Foreground='#000000'>도로 통행배정 통합 모형</TextBlock>")
		_T("  </StackPanel>")
		_T("</Border>"),
		w, h, fontSize1, w, w, fontSize2, fontSize2
	);
