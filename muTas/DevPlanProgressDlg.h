...
class KDevPlanProgressDlg : public KDialogEx
{
	DECLARE_DYNAMIC(KDevPlanProgressDlg)

public:
	KDevPlanProgressDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDevPlanProgressDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_5609_DevPlanProgressDlg };
