...
// KImChampMultiIDFind2Column 대화 상자입니다.

class KMapView;

class KImChampMultiIDFind2Column : public KResizeDialogEx, public ImChampMapSelectionReceiver
{
	DECLARE_DYNAMIC(KImChampMultiIDFind2Column)

public:
	KImChampMultiIDFind2Column(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KImChampMultiIDFind2Column();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_3013_FIND_MULTI_ID2COLUMN };
protected:
...
typedef std::shared_ptr<KImChampMultiIDFind2Column> KImChampMultiIDFind2ColumnPtr;