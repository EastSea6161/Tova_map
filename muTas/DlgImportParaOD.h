...
class KDlgImportParaOD : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportParaOD)

public:
	KDlgImportParaOD(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportParaOD();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_11_IMPORT_TABLE_PARAOD };
...
private:
	...
	bool         IsODZoneID(KODKey a_oODKey);
