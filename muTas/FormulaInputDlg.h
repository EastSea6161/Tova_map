...
class KFormulaInputDlg : public KDialogEx
{
	DECLARE_DYNAMIC(KFormulaInputDlg)

public:
	KFormulaInputDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KFormulaInputDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_6525_FORMULA_INPUT };
