...
class KDlgImportMode : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportMode)

public:
	KDlgImportMode(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportMode();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_10_IMPORT_TABLE_MODE };
