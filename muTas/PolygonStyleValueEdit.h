...
class KPolygonStyleValueEdit : public KDialogEx
{
	DECLARE_DYNAMIC(KPolygonStyleValueEdit)

public:
	KPolygonStyleValueEdit(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KPolygonStyleValueEdit();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_TOC_STYLE_POLYGON_VALUEEDIT };
...
protected:
	...
	void PreStyle(double& ar_dMin, double& ar_dMax);
