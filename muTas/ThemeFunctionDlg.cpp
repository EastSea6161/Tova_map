...
IMPLEMENT_DYNAMIC(KThemeFunctionDlg, KResizeDialogEx)

KThemeFunctionDlg::KThemeFunctionDlg(CWnd* pParent /*=NULL*/)
	: KResizeDialogEx(KThemeFunctionDlg::IDD, pParent)
	, m_strExpression(_T(""))
{

}

KThemeFunctionDlg::~KThemeFunctionDlg()
{
}

void KThemeFunctionDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(KThemeFunctionDlg, KResizeDialogEx)
	ON_LBN_DBLCLK(IDC_LIST1, &KThemeFunctionDlg::OnDblclkList1)
	ON_LBN_DBLCLK(IDC_LIST4, &KThemeFunctionDlg::OnDblclkList2)
	ON_LBN_DBLCLK(IDC_LIST3, &KThemeFunctionDlg::OnDblclkList3)
END_MESSAGE_MAP()


LPCTSTR KThemeFunctionDlg::Expression(void)
{
	return m_strExpression;
}


void KThemeFunctionDlg::Expression(LPCTSTR strExpression)
{
	m_strExpression = strExpression;
}


void KThemeFunctionDlg::FieldList(const std::list<std::tstring>& fieldList)
{
	m_FieldList = fieldList;
}


void KThemeFunctionDlg::FunctionList(const std::list<std::tstring>& functionList)
{
	m_FunctionList = functionList;
}


void KThemeFunctionDlg::OperatorList(const std::list<std::tstring>& operatorList)
{
	m_OperatorList = operatorList;
}


void KThemeFunctionDlg::updateFieldListBox(void)
{
...
void KThemeFunctionDlg::updateFunctionListBox(void)
{
...
void KThemeFunctionDlg::updateOperatorListBox(void)
{
...
BOOL KThemeFunctionDlg::OnInitDialog()
{
...
void KThemeFunctionDlg::OnDblclkList1(void)
{
	UpdateData(TRUE);
...
void KThemeFunctionDlg::OnDblclkList2(void)
{
	UpdateData(TRUE);
...
void KThemeFunctionDlg::OnDblclkList3(void)
{
	UpdateData(TRUE);
...
void KThemeFunctionDlg::ResizeComponent()
{
	...
	SetResize(IDC_LIST4,			CXTPResizePoint(0.5, 0.3),     CXTPResizePoint(0.7, 1));
