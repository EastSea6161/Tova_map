...
class KPA2ODParamImport1Dlg : public KDialogEx
{
	DECLARE_DYNAMIC(KPA2ODParamImport1Dlg)

public:
	KPA2ODParamImport1Dlg(
		BOOL a_bContainHeader, int a_nSeparatorType, int a_nEncodingType,
		CString a_strFileName, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KPA2ODParamImport1Dlg(void);

	enum { IDD = IDD_5830_PA2ODParamImport1Dlg };
