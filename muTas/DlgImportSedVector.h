...
class KDlgImportSedVector : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportSedVector)

public:
	KDlgImportSedVector(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportSedVector();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_12_IMPORT_TABLE_SEDVECTOR };
...
private:
	...
	bool         IsSubZoneID(Integer a_nxValue);
...
protected :
	...
	std::set<Integer>       m_setSubZoneID;
