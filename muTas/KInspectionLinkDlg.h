/**
 * @file KInspectionLinkDlg.h
 * @brief 링크데이터 오류 검증 다이얼로그
...
* @date 2011.08.28
*/
class KInspectionLinkDlg : public KResizeDialogEx
{
	DECLARE_DYNAMIC(KInspectionLinkDlg)
private:
    /**
...
public:
	KInspectionLinkDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KInspectionLinkDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_5120_InspectionLinkDlg };
...
typedef std::shared_ptr<KInspectionLinkDlg> KInspectionLinkDlgPtr;