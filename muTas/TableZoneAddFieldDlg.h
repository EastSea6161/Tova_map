...
class KTableZoneAddFieldDlg : public KDialogEx
{
	DECLARE_DYNAMIC(KTableZoneAddFieldDlg)

public:
	KTableZoneAddFieldDlg(KTarget* a_pTarget, KProject* a_pProject, KIOTable* a_pIOTable, int a_nColumnNumber, int a_nNewDisplayOrder, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KTableZoneAddFieldDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_4151_AddZoneFieldDlg };
...
protected:
	...
	afx_msg void OnBnClickedRadioPA(UINT nID);
