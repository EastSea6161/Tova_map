...
IMPLEMENT_DYNAMIC(KPA2ODPAImport1Dlg, KDialogEx)

KPA2ODPAImport1Dlg::KPA2ODPAImport1Dlg(
	BOOL a_bContainHeader, int a_nSeparatorType, int a_nEncodingType,
	CString a_strFileName, CWnd* pParent /*=NULL*/)
	: KDialogEx(KPA2ODPAImport1Dlg::IDD, pParent)
...
KPA2ODPAImport1Dlg::~KPA2ODPAImport1Dlg(void)
{
}

void KPA2ODPAImport1Dlg::DoDataExchange( CDataExchange* pDX )
{
...
BEGIN_MESSAGE_MAP(KPA2ODPAImport1Dlg, KDialogEx)
	ON_BN_CLICKED(IDOK, &KPA2ODPAImport1Dlg::OnBnClickedOk)
END_MESSAGE_MAP()

void KPA2ODPAImport1Dlg::ContainHeader( BOOL a_bContainHeader )
{
	m_bContainHeader = a_bContainHeader;
}

BOOL KPA2ODPAImport1Dlg::ContainHeader( void )
{
	return m_bContainHeader;
}

void KPA2ODPAImport1Dlg::SeparatorType( int a_nSepartorType )
{
	m_nSeparatorType = a_nSepartorType;
}

int KPA2ODPAImport1Dlg::SeparatorType( void )
{
	return m_nSeparatorType;
}

void KPA2ODPAImport1Dlg::EncodingType( int a_nEncodingType )
{
	m_nEncodingType = a_nEncodingType;
}

int KPA2ODPAImport1Dlg::EncodingType( void )
{
	return m_nEncodingType;
}

void KPA2ODPAImport1Dlg::FileName( CString a_strFileName )
{
	m_strFileName = a_strFileName;
}

CString KPA2ODPAImport1Dlg::FileName( void )
{
	return m_strFileName;
}

BOOL KPA2ODPAImport1Dlg::OnInitDialog()
{
...
void KPA2ODPAImport1Dlg::OnBnClickedOk()
{
	UpdateData( TRUE );
