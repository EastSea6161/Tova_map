/**
 * @file IntersectionThreeBasicPage.h
 * @brief KIntersectionThreeBasicPage 선언 파일
...
/**
 * @brief 3지 용 Intersection Basic 설정 page class
 * @remark
 * @warning
 * @version 1.0
 * @author jyk@qbicware.com
 * @date 2012.06.11
 */
class KIntersectionThreeBasicPage : public KDialogEx
{
	DECLARE_DYNAMIC(KIntersectionThreeBasicPage)

public:
	KIntersectionThreeBasicPage(KDBaseConPtr spDBaseConnection, TIntersectionBase &a_oTSelectIntersection, std::map<Integer, TBoundInfo> &a_mapBoundInfo, CWnd* pParent = NULL);
	virtual ~KIntersectionThreeBasicPage();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_5950_IntersectionThreeBasicPage };
...
protected:
	...
	*/
	...
	void InitButtonCtrlStatus( int a_nCrossType );
...
public:
	static void DefaultModuleDataSet(std::vector<TSignalIndication> &a_vecSignalSeq, TIntersectionBase &a_oTSelectIntersection);
