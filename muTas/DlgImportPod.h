...
class KDlgImportPod : public KWhiteDlgEx
{
	DECLARE_DYNAMIC(KDlgImportPod)

public:
	KDlgImportPod(KTarget* a_pTarget, KIOTable* a_pTable, CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KDlgImportPod();

	// 대화 상자 데이터입니다.
	enum { IDD = IDD_201_01_09_IMPORT_TABLE_PURPOSE };
