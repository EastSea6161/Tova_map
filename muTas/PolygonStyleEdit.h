...
class KPolygonStyleEdit : public KDialogEx
{
	DECLARE_DYNAMIC(KPolygonStyleEdit)

public:
	KPolygonStyleEdit(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KPolygonStyleEdit();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_TOC_STYLE_POLYGON_TYPEEDIT };
