...
class KCO2EmissionsEquationFnDlg : public KResizeDialogEx
{
	DECLARE_DYNAMIC(KCO2EmissionsEquationFnDlg)

public:
	KCO2EmissionsEquationFnDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KCO2EmissionsEquationFnDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_8541_KCO2EmissionsEquationFnDlg };
