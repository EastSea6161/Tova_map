...
class KLineStyleValueEdit : public KDialogEx
{
	DECLARE_DYNAMIC(KLineStyleValueEdit)

public:
	KLineStyleValueEdit(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~KLineStyleValueEdit();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_TOC_STYLE_LINE_VALUEEDIT };
