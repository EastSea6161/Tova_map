...
namespace UIGeneration
{
	...
	const CString KR_UIXAML_G_INPUT_FALSE
		(
		_T("<Border Width='116' Height='88' Margin='0,0,0,0' BorderBrush='Red' BorderThickness='0,0,0,0' CornerRadius='2,2,2,2'>")
		_T("  <Border.Background>")
		_T("    <LinearGradientBrush EndPoint='0.504,1.5' StartPoint='0.504,0.03'>")
...
// 		_T("    <Border Height='1' Background='#a0a5a8' />")
// 		_T("    <Border Height='1' Background='#cdd1d4' />")
		_T("    <TextBlock TextAlignment='Center'  FontWeight='Bold' Foreground='#666666'>¸ðÇü½Ä ÀÔ·Â</TextBlock>")   
		_T("  </StackPanel>")
		_T("</Border>")
		);
...
// 		_T("    <Border Height='1' Background='#ddc09e' />")
// 		_T("    <Border Height='1' Background='#ffffff' />")
		_T("    <TextBlock TextAlignment='Center' FontWeight='Bold' Foreground='#663333'>¸ðÇü½Ä ÀÔ·Â</TextBlock>")    
		_T("  </StackPanel>")
		_T("</Border>")
		);
...
// 		_T("    <Border Height='1' Background='#7c96b5' />")
// 		_T("    <Border Height='1' Background='#9acae4' />")
		_T("    <TextBlock TextAlignment='Center' FontWeight='Bold' Foreground='#003366'>¸ðÇü½Ä ÀÔ·Â</TextBlock>")    
		_T("  </StackPanel>")
		_T("</Border>")
		);
...
// 		_T("    <Border Height='1' Background='#ddc09e' />")
// 		_T("    <Border Height='1' Background='#ffffff' />")
		_T("    <TextBlock TextAlignment='Center' FontWeight='Bold' Foreground='#663333'>Àû¿ë ¸ðÇü ¼³Á¤</TextBlock>")  
		_T("  </StackPanel>")
		_T("</Border>")
		);
...
// 		_T("    <Border Height='1' Background='#7c96b5' />")
// 		_T("    <Border Height='1' Background='#9acae4' />")
		_T("    <TextBlock TextAlignment='Center' FontWeight='Bold' Foreground='#003366'>Àû¿ë ¸ðÇü ¼³Á¤</TextBlock>")  
		_T("  </StackPanel>")
		_T("</Border>")
		);
