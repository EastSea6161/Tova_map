...
IMPLEMENT_DYNAMIC(KAccessTripODToVehODDlg, CDialogEx)

KAccessTripODToVehODDlg::KAccessTripODToVehODDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_7001_UTIL_AccessTripODtoVehOD, pParent)
{
...
KAccessTripODToVehODDlg::~KAccessTripODToVehODDlg()
{
}

void KAccessTripODToVehODDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(KAccessTripODToVehODDlg, CDialogEx)
	ON_BN_CLICKED(ID_RUN, &KAccessTripODToVehODDlg::OnBnClickedRun)
	ON_BN_CLICKED(IDC_BTN_ODFILE, &KAccessTripODToVehODDlg::OnBnClickedBtnOdfile)
	ON_BN_CLICKED(IDC_CHECK4, &KAccessTripODToVehODDlg::OnBnClickedCheck4)
	ON_CBN_SELCHANGE(IDC_COMBO1, &KAccessTripODToVehODDlg::OnCbnSelchangeCombo1)
	ON_CBN_SELCHANGE(IDC_COMBO2, &KAccessTripODToVehODDlg::OnCbnSelchangeCombo2)
	ON_NOTIFY(XTP_NM_REPORT_RECORDS_DROPPED, IDC_REPORT1, &KAccessTripODToVehODDlg::OnReportRecordsDropped)
	ON_BN_CLICKED(IDC_BTN_CONVERT_EXCEL, &KAccessTripODToVehODDlg::OnBnClickedBtnConvertExcel)
	ON_MESSAGE(WM_THREAD_FINISHED, &KAccessTripODToVehODDlg::OnThreadFinished)
END_MESSAGE_MAP()


// KAccessTripODToVehODDlg 메시지 처리기

BOOL KAccessTripODToVehODDlg::OnInitDialog()
{
...
void KAccessTripODToVehODDlg::OnBnClickedRun()
{
	if (!m_bLoadFile)
	{
...
void KAccessTripODToVehODDlg::LoadDistributionList()
{
	try
	{
...
void KAccessTripODToVehODDlg::InitComboSeparator()
{
	try
	{
...
void KAccessTripODToVehODDlg::InitComboEncoding()
{
	try
	{
...
void KAccessTripODToVehODDlg::InitReportColumn()
{
	TxLogDebugStartMsg();
...
void KAccessTripODToVehODDlg::InitODColumn()
{
	TxLogDebugStartMsg();
...
void KAccessTripODToVehODDlg::LoadConfigFile()
{
	try
	{
		TCHAR szModulePath[MAX_PATH] = { 0 };
		...
		CString configPath = basePath + _T("Utility\\TripODToVehOD\\AccessTripODToVehODConfig.json");
	...
	catch (int& ex)
	{
		...
		if (ex == 1)
		{
			strError.Format(_T("AccessTripODToVehODConfig.json 설정 파일을 열 수 없습니다."));
			AfxMessageBox(strError);
		}
		else
		{
...
bool KAccessTripODToVehODDlg::GetColumnInfo(CString region, CString year, std::vector<ColumnInfo>& columnInfo)
{
...
void KAccessTripODToVehODDlg::OnBnClickedBtnOdfile()
{
...
void KAccessTripODToVehODDlg::OnBnClickedCheck4()
{
	if (m_bLoadFile)
	{
...
void KAccessTripODToVehODDlg::OnCbnSelchangeCombo1()
{
	if (m_bLoadFile)
	{
		int areaIdx = m_cboAreaNumber.GetCurSel();
...
void KAccessTripODToVehODDlg::OnCbnSelchangeCombo2()
{
	if (m_bLoadFile)
	{
		m_cboDistributionYear.GetWindowText(m_strYear);
...
void KAccessTripODToVehODDlg::OnReportRecordsDropped(NMHDR* pNotifyStruct, LRESULT* pResult)
{
...
void KAccessTripODToVehODDlg::OnBnClickedBtnConvertExcel()
{
	KExcelExportConfigDlg dlg(this);
	dlg.DoModal();
}

LRESULT KAccessTripODToVehODDlg::OnThreadFinished(WPARAM wParam, LPARAM lParam)
{
	DrawingLoadingGif(false);
...
void KAccessTripODToVehODDlg::CheckSeperator(CString a_strFile)
{
	try
	{
...
void KAccessTripODToVehODDlg::CheckEncoding(CString a_strFile)
{
	try
	{
...
void KAccessTripODToVehODDlg::CheckImportHeader(CString a_strFile)
{
	try
	{
		QBicTxtReader oReader;
...
TCHAR KAccessTripODToVehODDlg::GetSelectedSeparator()
{
...
int KAccessTripODToVehODDlg::GetSelectedEncoding()
{
...
void KAccessTripODToVehODDlg::UpdatePreviewReport()
{
	TxLogDebugStartMsg();
...
void KAccessTripODToVehODDlg::UpdateODColumnReport()
{
	TxLogDebugStartMsg();
...
void KAccessTripODToVehODDlg::UpdateFileColumnReport()
{
	TxLogDebugStartMsg();
...
bool KAccessTripODToVehODDlg::LoadCSVPreviewData()
{
	TxLogDebugStartMsg();
	m_Rows.clear();
	m_ColumnRow.clear();
...
void KAccessTripODToVehODDlg::ParseCSVLineString(CString& strLine, TCHAR tcSeparator, CSVRow& row)
{
	bool bQuote(false);
	int  nSub(0);
...
bool KAccessTripODToVehODDlg::LoadExcelAutoFactorData()
{
	try
	{
...
bool KAccessTripODToVehODDlg::LoadExcelAccessFactorData()
{
	try
	{
		if (m_strRegion.IsEmpty() || m_strYear.IsEmpty())
...
bool KAccessTripODToVehODDlg::GetAutoScaleFactorValue(int nO, int nD, double& dValue)
{
	ODKey key(nO, nD);
...
bool KAccessTripODToVehODDlg::GetAccessScaleFactorValue(int nO, AccessFactorType& factorData)
{
...
bool KAccessTripODToVehODDlg::GetScaleFactorValue(int nO, int nD, int nCol, double& dValue)
{
...
void KAccessTripODToVehODDlg::SetCurColumnInfo()
{
	try
	{
		if (m_strRegion.IsEmpty() || m_strYear.IsEmpty())
...
bool KAccessTripODToVehODDlg::BulildODDataSet()
{
	try
	{
...
bool KAccessTripODToVehODDlg::ExportVehODFile()
{
	try
	{
...
void KAccessTripODToVehODDlg::DrawingLoadingGif(bool bStart)
{
...
UINT KAccessTripODToVehODDlg::ThreadWorker(LPVOID pParam)
{
	KAccessTripODToVehODDlg* pDlg = (KAccessTripODToVehODDlg*)pParam;
