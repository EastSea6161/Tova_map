// TablePurposeAddFieldDlg.cpp : 구현 파일입니다.
//
...
IMPLEMENT_DYNAMIC(KTablePurposeAddFieldDlg, KDialogEx)

KTablePurposeAddFieldDlg::KTablePurposeAddFieldDlg(KTarget* a_pTarget, KProject* a_pProject, KIOTable* a_pIOTable, int a_nColumnNumber, int a_nNewDisplayOrder, CWnd* pParent /*=NULL*/)
	: KDialogEx(KTablePurposeAddFieldDlg::IDD, pParent)
	, m_bCode( false )
	, m_strColumnName(_T(""))
	, m_strColumnInfo(_T(""))
	, m_nCodeGroup(-1)
...
KTablePurposeAddFieldDlg::~KTablePurposeAddFieldDlg()
{
...
void KTablePurposeAddFieldDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(KTablePurposeAddFieldDlg, KDialogEx)
	ON_BN_CLICKED(IDOK, &KTablePurposeAddFieldDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDC_RADIO1, &KTablePurposeAddFieldDlg::OnBnClickedColumnData)
	ON_BN_CLICKED(IDC_RADIO2, &KTablePurposeAddFieldDlg::OnBnClickedColumnCode)

	ON_BN_CLICKED(IDCANCEL, &KTablePurposeAddFieldDlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDC_CHECK_DEF, &KTablePurposeAddFieldDlg::OnBnClickedCheckDef)
	ON_WM_SHOWWINDOW()
END_MESSAGE_MAP()


// KTablePurposeAddFieldDlg 메시지 처리기입니다.
BOOL KTablePurposeAddFieldDlg::PreTranslateMessage( MSG* a_pMsg )
{
...
BOOL KTablePurposeAddFieldDlg::OnInitDialog()
{
...
void KTablePurposeAddFieldDlg::InitGroupCode(std::map<CString, int> &mapGroupCode)
{
    CString strSQL(_T(""));
...
void KTablePurposeAddFieldDlg::InitialPurposeInfo(void)
{
	try
	{
...
void KTablePurposeAddFieldDlg::SettingControlByMode()
{
	UpdateData(TRUE);
...
void KTablePurposeAddFieldDlg::OnBnClickedOk()
{
	UpdateData( TRUE );
...
bool KTablePurposeAddFieldDlg::CreateAddColumn()
{
	try
	{
...
void KTablePurposeAddFieldDlg::OnBnClickedCancel()
{
	KDialogEx::OnCancel();
}


void KTablePurposeAddFieldDlg::OnBnClickedColumnData()
{
...
void KTablePurposeAddFieldDlg::OnBnClickedColumnCode()
{
...
void KTablePurposeAddFieldDlg::OnBnClickedCheckDef()
{
	ActiveDefineControl();
}


void KTablePurposeAddFieldDlg::ActiveDefineControl()
{
...
void KTablePurposeAddFieldDlg::OnShowWindow(BOOL bShow, UINT nStatus)
{
