...
*@version 1.0.0
*/
class ThunderMapCommandMPan : public IThunderMapCommand
{
public:
    ThunderMapCommandMPan(IThunderMap* pThunderMap, Gdiplus::Color crBackground = Gdiplus::Color::White);
    virtual ~ThunderMapCommandMPan();
...
typedef std::shared_ptr<ThunderMapCommandMPan> ThunderMapCommandMPanPtr;