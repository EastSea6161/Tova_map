...
inline int QBicPictureEx::TGIFControlExt::GetPackedValue(enum ControlExtValues Value)
{
...
inline int QBicPictureEx::TGIFLSDescriptor::GetPackedValue(enum LSDPackedValues Value)
{
    int nRet = (int)m_cPacked;
...
inline int QBicPictureEx::TGIFImageDescriptor::GetPackedValue(enum IDPackedValues Value)
{
    int nRet = (int)m_cPacked;
...
BEGIN_MESSAGE_MAP(QBicPictureEx, CStatic)
...
BOOL QBicPictureEx::Load(HGLOBAL hGlobal, DWORD dwSize)
{
...
SIZE QBicPictureEx::GetSize() const
{
    return m_PictureSize;
}

BOOL QBicPictureEx::Load(LPCTSTR szFileName)
{
    ASSERT(szFileName);
...
BOOL QBicPictureEx::Load(LPCTSTR szResourceName, LPCTSTR szResourceType)
{
...
void QBicPictureEx::ResetDataPointer()
{
...
BOOL QBicPictureEx::SkipNextGraphicBlock()
{
...
UINT QBicPictureEx::GetSubBlocksLen(UINT nStartingOffset) const
{
    UINT nRet = 0;
...
enum QBicPictureEx::GIFBlockTypes QBicPictureEx::GetNextBlock() const
{
...
BOOL QBicPictureEx::SkipNextBlock()
{
    if (!m_pRawData) return FALSE;
...
int QBicPictureEx::GetNextBlockLen() const
{
...
UINT WINAPI QBicPictureEx::_ThreadAnimation(LPVOID pParam)
{
    ASSERT(pParam);
    QBicPictureEx *pPic = reinterpret_cast<QBicPictureEx *> (pParam);
...
void QBicPictureEx::ThreadAnimation()
{
...
HGLOBAL QBicPictureEx::GetNextGraphicBlock(UINT *pBlockLen, 
...
BOOL QBicPictureEx::IsGIF() const
{
    return m_bIsGIF;
}

BOOL QBicPictureEx::IsAnimatedGIF() const
{
    return (m_bIsGIF && (m_arrFrames.size() > 1));
}

BOOL QBicPictureEx::IsPlaying() const
{
    return m_bIsPlaying;
}

int QBicPictureEx::GetFrameCount() const
{
    if (!IsAnimatedGIF())
        return 0;
...
COLORREF QBicPictureEx::GetBkColor() const
{
    return m_clrBackground;
}

void QBicPictureEx::OnPaint() 
{
...
BOOL QBicPictureEx::PrepareDC(int nWidth, int nHeight)
{
...
void QBicPictureEx::OnDestroy() 
{
    Stop();	
    CStatic::OnDestroy();
}

void QBicPictureEx::SetBkColor(COLORREF clr)
{
...
#ifdef GIF_TRACING
void QBicPictureEx::WriteDataOnDisk(CString szFileName, HGLOBAL hData, DWORD dwSize)
{
    CFile file;
...
void QBicPictureEx::EnumGIFBlocks()
{
    enum GIFBlockTypes nBlock;
...
BOOL QBicPictureEx::SetPaintRect(const RECT *lpRect)
{
    return CopyRect(&m_PaintRect, lpRect);
}

BOOL QBicPictureEx::GetPaintRect(RECT *lpRect)
{
