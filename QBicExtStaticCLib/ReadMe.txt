========================================================================
    정적 라이브러리 : QBicExtStaticCLib 프로젝트 개요
========================================================================

1) 라이브러리 중 : Proj.4fmf 사용하는 부분을 주석으로 처리



응용 프로그램 마법사에서 이 QBicExtStaticCLib 라이브러리 프로젝트를 만들었습니다.

프로젝트에 대해 소스 파일은 만들어지지 않았습니다.


QBicExtStaticCLib.vcxproj
...
QBicExtStaticCLib.vcxproj.filters
