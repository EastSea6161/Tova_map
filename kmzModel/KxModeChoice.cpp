#include "KxModeChoice.h"

KxModeChoice::KxModeChoice(void)
{
}
...
KReturn::KEMReturn KxModeChoice::MuExecute( KODKeyDoubleRecords&   _paraOD, 
...
void KxModeChoice::CalculateModeOD( KODKeyDoubleRecords&  _objectOD, int ODIndex,
                                    KDTreeNodeCollection& _tree,
...
void KxModeChoice::CalculateRate( KDTreeNodeCollection& _tree, 
...
void KxModeChoice::CalculateUtilityValue( KODKeyDoubleRecords&  _paraOD, 
                                          KDTreeNodeCollection& _tree, 
                                          KODKeyDoubleRecords&  utilityOD, 
                                          void (*func_ptr_msg)(CAtlString strMsg) )
{
...
void KxModeChoice::CalculateModeUtilityValue( KODKeyDoubleRecords&  _paraOD,
                                           ...
                                           )
{
    ...
    KParser oParser;
    oParser.SetExpr(_pModeNode->GetUtilityFunction().GetBuffer());

    for ( size_t i=0; i<nVariablesCount; i++ )
    {
        KParseVariableInfo* pVariableInfo = _pModeNode->GetParseVariableInfo(i);
        oParser.DefineVar(pVariableInfo->GetVariableName().GetBuffer(), &dVariable[i]);
    }
...
void KxModeChoice::CalculateNestedUtilityValue ( KODKeyDoubleRecords&  _paraOD,
