...
public:
    KReturn::KEMReturn 
        MuExecute ( KODKeyDoubleRecords&   _paraOD, int distanceIndex, double shortDistance,
	...
	KReturn::KEMReturn 
		PolicyModeChoiceMuExecute ( KODKeyDoubleRecords&   _paraOD, int distanceIndex, double shortDistance,
		KDTreeNodeCollection&  _tree, 
		KODKeyDoubleRecords&   _objectOD, int ODIndex,  
		KODKeyDoubleRecords&   updatedReturnOD, 
		void (*func_ptr_msg)(CAtlString strMsg) = NULL
...
private:
    ...
    void CalculateModeOD( KODKeyDoubleRecords&  _objectOD, int ODIndex, KODKeyDoubleRecords& _paraOD, int distanceIndex, double shortDistance,
        KDTreeNodeCollection& _tree,
        KODKeyDoubleRecords&  _utilityOD, 
        KODKeyDoubleRecords&  updatedReturnOD, 
        void (*func_ptr_msg)(CAtlString strMsg) = NULL
        );
	void CalculatePolicyModeOD( KODKeyDoubleRecords& _objectOD, int ODIndex, KODKeyDoubleRecords& _paraOD, int distanceIndex, double shortDistance, 
		KDTreeNodeCollection& _tree, KODKeyDoubleRecords& _utilityOD, KODKeyDoubleRecords& updatedReturnOD, void (*func_ptr_msg)(CAtlString strMsg)  = NULL );
};
